...
app.post('/api/textures', async (req, res) => {
    ...
    try {
        ...
        res.json({
            ...
            stumbleCupsVersion: config?.stumble_cups_version || '1.0',
            keyShortener: config?.key_shortener,
            profileUrl: config?.profile_url || config?.profile_image || 'https://i.imgur.com/bLKgTww.png',
            defaultBannerUrl: config?.default_banner_url || 'https://i.imgur.com/bLKgTww.png',
